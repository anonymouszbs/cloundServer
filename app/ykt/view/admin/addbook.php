    ...
    <div class="layuimini-container">
        <div class="layuimini-main">
            <div class="layui-row">
                            ...
                            <form class="layui-form layui-form-pane" action="" lay-filter="thisForm">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block" style="margin-left: 200px;">
                                        <div class="layui-upload">
                                            ...
                                            <img id="showimg" style="display:none;width: 108px;height:108px;  position: absolute; top: 0%; left:600px;" src="https://th.bing.com/th/id/OIP.-lYSAnw4J2Vx2p6v3eyMAAHaER?pid=ImgDet&rs=1">
                                        </div>
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-inline">
                                        <select name="authorid" lay-filter="authorid" lay-verify="authorid">
                                            <option value="{$aUser['id']}">{$aUser['username']}</option>
                                        </select>
                                    </div>
                                    <label class="layui-form-label" style="width: 200px;">教材目录</label>
                                    <div class="layui-input-inline">
                                        <select name="parentnodeid" lay-filter="parentnodeid" lay-verify="parentnodeid">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" lay-verify="required" name="ietm_name" class="layui-input" style="width:200px;" autocomplete="off">
                                    </div>
                                    <label class="layui-form-label" style="width: 200px;">教材版本号</label>
                                    <div class="layui-input-inline">
                                        <input type="text" lay-verify="required" name="Version" class="layui-input" style="width:200px;" autocomplete="off">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label" style="width: 200px;">维度1</label>
                                    <div class="layui-input-inline">
                                        <select name="Dimension1" lay-filter="Dimension1" lay-verify="Dimension1">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-inline">
                                        <input placeholder="注释{多个标签使用，号隔开}" type="text" lay-verify="KeyWord" name="KeyWord" class="layui-input" style="width:200px;" autocomplete="off">
                                    </div>
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-inline">
                                        <select name="isstudyplan" lay-filter="isstudyplan" lay-verify="isstudyplan">
                                ...
                                <div class="layui-form-item layui-form-text" style="width:800px;">
                                    ...
                                    <div class="layui-input-block">
                                        <textarea name="Introduction" lay-verify="" placeholder="请输入书籍简介" class="layui-textarea" autocomplete="off"></textarea>
                                    </div>
                                </div>

                                <div class="layui-form-item">
                                    <div class="layui-input-block">
                                        <button class="layui-btn layui-btn-normal" lay-submit="" lay-filter="submit">点击发布</button>
                                    </div>
                ...
                <div class="layui-col-md5" id="right-form">
                    <div class="layui-card">
    ...
    <script>
        ...
        layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'form', 'laydate', 'jquery'], function() {
            ...
            upload.render({
                ...
                exts: 'epub|wav|wma|flac|mp4|mp3|avi|mkv|doc|pdf|docx',
                auto: false,
                choose: function(obj) {
                    // 获取文件信息
            ...
            form.on('submit(submit)', function(data) {
                ...
                // isstudyplan: 1
                // Introduction: 书籍简介
                // filepath: /storage/uploads / admin / document / 20230524 / bf4586c0e2f4cba62c813c32ffb08507.doc
                // fileattr: doc
                // reciveuser: 2 | 3 | 4 | 5 | 6 |
                //     Thumbnail: /storage/uploads / admin / img / 20230524 / f15bc368ff0733a9262c72194a374097.jpg
                ...
                $.post("{$config['admin_route']}admin/addbookresource", dataj, function(res) {
                    layer.close(index);
                    var code = res.code;
                    var msg = res.msg;
                    switch (code) {
